 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://amdocs.com", wsdlLocation = "http://localhost:8080/HelloSOAP/services/Hello?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/HelloSOAP/services/Hello?wsdl");
